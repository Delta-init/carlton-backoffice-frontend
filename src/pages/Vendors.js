        ...
        <DialogContent className="bg-white border-slate-200 text-slate-800 max-w-4xl max-h-[90vh] overflow-hidden">
          ...
          {viewExchanger && (
            <div className="space-y-4">
              ...
              <div className="p-4 bg-slate-50 rounded-xl border-l-4 border-l-[#1FA21B]">
                <p className="text-xs text-blue-600 uppercase tracking-wider mb-3">
                  Settlement Balance by Currency (Deposits - Withdrawals -
                  Commission)
                </p>
                      ...
                      <div key={idx} className="space-y-1">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            <span
                              className={`text-lg font-bold font-mono ${item.usd_equivalent >= 0 ? "text-blue-600" : "text-red-400"}`}
                            >
                              {item.amount?.toLocaleString()}
                            </span>
                            {item.currency !== "USD" && (
                        ...
                        <div className="flex justify-between text-xs text-slate-500 pl-2">
                          ...
                          <span className="text-red-400">
                            ...
                            withdrawals ({item.withdrawal_count})
                          </span>
                        </div>
                  ...
                  >
                    ...
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="text-yellow-400">
                        -${item.commission_earned_usd?.toLocaleString()}
                        {item.currency !== "USD" &&
                          ` (${item.commission_earned_base?.toLocaleString()} ${item.currency})`}
                      </span>
                    </div>
                    {item.currency !== "USD" && (
                      <div className="flex justify-between text-xs">
